...
export interface Scalars {
  ...
  schema_bshb_workflow__974973832: {
    timestamp: string;
    type: "block.updated";
    data: {
      blockId: string;
...
export interface BlogGenqlSelection {
  ...
  posts?: PostsGenqlSelection & {
    __args?: {
      ...
      /** Skip the first n items. */
      skip?: Scalars["Int"] | null;
      variants?: Language__VariantsInput | null;
    };
  };
...
export interface Language__VariantsInput {
...
export interface QueryGenqlSelection {
  ...
  blog?: BlogGenqlSelection & {
    __args?: { variants?: Language__VariantsInput | null };
  };
