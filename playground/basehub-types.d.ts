...
export interface Scalars {
  ...
  type: "file"
    ...
    JSON: any,
    String: string,
    bshb_workflow__788491620: `bshb_workflow__788491620:${string}`,
    schema_bshb_workflow__788491620: { timestamp: string, type: 'block.updated', data: {
  blockId: string;
  blockIdPath: string
} },
}
...
export type BlockDocument = (Authors | AuthorsItem | Blog | Language | Posts | PostsItem | Settings | _AgentStart | authorsItem_AsList | postsItem_AsList) & { __isUnion?: true }
...
export interface Translator {
    ...
    webhookSecret: Scalars['bshb_workflow__788491620']
